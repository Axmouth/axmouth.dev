...
use lettre::{
    ...
    ClientSecurity, ClientTlsParameters, SendableEmail, SmtpClient, Transport,
};
    ...
    pub fn send_reset_password_email(
        ...
        let email = Email::builder()
            ...
            .alternative(
                ...
                self.get_reset_password_email_html(username, token),
            )
            .build()?;
