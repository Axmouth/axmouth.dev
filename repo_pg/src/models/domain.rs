...
#[ts(export, export_to = "bindings/responses/BlogPostComment.ts")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/BlogPost.ts")]
#[serde(rename_all = "camelCase")]
pub struct BlogPost {
    pub id: i32,
    pub title: String,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/Project.ts")]
#[serde(rename_all = "camelCase")]
pub struct Project {
    pub id: i32,
    pub body: String,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/User.ts")]
#[serde(rename_all = "camelCase")]
pub struct User {
    pub id: i32,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/Technology.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/Category.ts")]
#[serde(rename_all = "camelCase")]
pub struct Category {
    pub id: i32,
    pub name: String,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/RefreshToken.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/UploadedImage.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/TextBody.ts")]
#[serde(rename_all = "camelCase")]
pub struct TextBody {
    pub id: i32,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/IdentificationCookie.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/VerifyEmailToken.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/PageView.ts")]
#[serde(rename_all = "camelCase")]
pub struct PageView {
    pub id: i32,
    pub page_url: String,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/BlogPostCommentRating.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/BlogPostCommentFlag.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/AdminLog.ts")]
#[serde(rename_all = "camelCase")]
pub struct AdminLog {
    pub id: i32,
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/ChangePasswordToken.ts")]
#[serde(rename_all = "camelCase")]
...
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, TS)]
#[ts(export, export_to = "bindings/responses/SearchItem.ts")]
#[serde(rename_all = "camelCase")]
