...
export class AuthService {
  ...
  authenticate(data?: any): Observable<AuthResult> {
    ...
    const result = this.http
      .post<Response<AuthSuccess>>(`${this.authEndpointPrefix}login`, data, {
        observe: 'response',
        withCredentials: true,
        headers,
      })
  ...
  logout(): Observable<AuthResult> {
    ...
    const result = of({}).pipe(
      switchMap((res: any) => {
        ...
        return this.http.delete<Response<null>>(url, { observe: 'response', withCredentials: true, headers });
      }),
      map((res) => {
        return new AuthResult(
          true,
  ...
  register(data?: any): Observable<AuthResult> {
    ...
    headers.append('Content-Type', 'application/json');
    const result = this.http
      .post<Response<AuthSuccess>>(url, data, { observe: 'response', withCredentials: true, headers })
      .pipe(
        map((res) => {
          return new AuthResult(
            true,
  ...
  requestPasswordReset(data?: any): Observable<AuthResult> {
    ...
    const headers = new HttpHeaders();
    headers.append('Content-Type', 'application/json');
    return this.http.post(url, data, { observe: 'response', withCredentials: true, headers }).pipe(
      map((res) => {
        return new AuthResult(
          true,
          res,
